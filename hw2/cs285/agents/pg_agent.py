...
class PGAgent(BaseAgent):
    ...
    def _discounted_return(self, rewards):
        ...
        discounts = np.power(np.ones(T) * self.gamma, indices)
        ...
        list_of_discounted_returns = sum_of_discounted_rewards * np.ones(T)
    ...
    def _discounted_cumsum(self, rewards):
        ...
        for start_time_index in range(T): 
            ...
            discounts = np.power(np.ones(len(indices)) * self.gamma, indices - start_time_index)
